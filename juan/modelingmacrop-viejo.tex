...
% 	En este artículo desarrollamos un marco analítico para describir la dinámica de transmisión de infecciones parasitarias. 
% 	Primero realizamos una descripcion de la dinámica de transmisión y presentamos un modelo
% 	%de infecciones parasitarias 
% 	para una comunidad de hospedadores homogenea. Luego presentamos un modelo para el caso de comunidad de hospedadore heterogenea. En ambos modelo se consideran caracteriticas reproductivas del parasito como produccion de huevos y la probabilidad de pareamiento, esta ultimas modeladas por la fecundidad denso-dependiente del parasito y la distribucioń de parasitos por hopedador que asumimos binomial negativa.      	
% 	analizamos los patrones epidemiológicos de estas infecciones. 
% 	Estudiamos la distribución individual de los parásitos en la comunidad de hospedantes y también la distribución por sexo de los parásitos. De esto obtenemos expresiones para la producción de huevos fertilizados y la probabilidad de apareamiento de los parásitos. Para estas últimas variables consideramos una fecundidad dependiente de la densidad, característica de los helmintos parásitos.	
...
% 	para ambos modelos we present the calculations of the equilibrium values 
% 	%of the model 
% 	and the basic reproduction number $R_0$ defined for case of macroparasitos as the average number of new parasite offspring caused by one typical parasite, from one generation to the next. 
%
% 	Para el modelo homogeneo We show that 
% 	%our model 
...
%		\caption{In the graph we observe the three equilibria. The stable equilibrium at $M^*=$, the unstable equilibrium at $M^*=$ and the extinction equilibrium at $M^*=0$. Parameter values  }
	...
	{\color{red}
		...
		%that allow the growth of $R_0$ are equally important. 
